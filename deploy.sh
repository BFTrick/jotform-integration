...
# main config
PLUGINSLUG="jotform-integration"
CURRENTDIR=`pwd`
MAINFILE="jotform-integration.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/jotform-integration/" # Remote SVN repo on wordpress.org, with no trailing slash
